        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-20">
            ...
            >
              ...
              <h1 className="text-4xl md:text-7xl font-extrabold tracking-tight mb-8 bg-gradient-to-b from-white via-slate-100 to-slate-400 bg-clip-text text-transparent">
                {content.missionTitle}
              </h1>
              <p className="text-base md:text-lg text-slate-300 max-w-3xl mx-auto leading-relaxed font-semibold">
                {content.missionDesc}
              </p>
            </motion.div>
          </div>
          ...
          <div className="relative h-[440px] rounded-3xl overflow-hidden mb-24 border border-slate-900 shadow-2xl group">
            <img 
