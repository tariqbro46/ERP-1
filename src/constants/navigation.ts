...
export const NAV_ITEMS: NavGroup[] = [
  {
    ...
    items: [
      { id: 'ledger-new', to: '/accounts/ledgers/new', icon: UserPlus, iconName: 'UserPlus', label: 'Create Ledger', labelKey: 'nav.createLedger', permission: 'acc_masters_create' },
      { id: 'item-new', to: '/inventory/items/new', icon: Plus, iconName: 'Plus', label: 'Create Item', labelKey: 'nav.createItem', feature: 'inv', permission: 'inv_masters_create' },
      { id: 'godowns', to: '/inventory/godowns', icon: MapPin, iconName: 'MapPin', label: 'Godowns', labelKey: 'nav.godowns', feature: 'inv', permission: 'inv_masters_create' },
      { id: 'employees', to: '/employees', icon: Users, iconName: 'Users', label: 'Employee Master', labelKey: 'nav.employeeMaster', permission: 'pay_masters' },
      { id: 'accounts', to: '/accounts', icon: Database, iconName: 'Database', label: 'Chart of Accounts', labelKey: 'nav.chartOfAccounts', permission: 'acc_masters_create' },
      { id: 'items', to: '/inventory/items', icon: Package, iconName: 'Package', label: 'Item Master', labelKey: 'nav.itemMaster', feature: 'inv', permission: 'inv_masters_create' },
      { id: 'alter', to: '/alter', icon: SettingsIcon, iconName: 'Settings', label: 'Alter', labelKey: 'nav.alter', permission: 'acc_masters_alter' },
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      { id: 'payroll-mgmt', to: '/payroll', icon: DollarSign, iconName: 'DollarSign', label: 'Payroll Management', labelKey: 'nav.payrollManagement', feature: 'pay', permission: 'pay_transactions' },
    ]
  },
  {
    id: 'group-production',
    ...
    items: [
      { id: 'prod-orders', to: '/production/orders', icon: Printer, iconName: 'Printer', label: 'Order Management', labelKey: 'nav.orderManagement', feature: 'ord', permission: 'ord_create' },
      { id: 'prod-machines', to: '/production/machines', icon: Cpu, iconName: 'Cpu', label: 'Machine Management', labelKey: 'nav.machineManagement', feature: 'mac', permission: 'mac_manage' },
      { id: 'prod-reports', to: '/production/reports', icon: BarChart3, iconName: 'BarChart3', label: 'Production Reports', labelKey: 'nav.productionReports', feature: 'ord', permission: 'ord_reports' },
    ]
  },
  {
    id: 'group-reports',
    ...
    to: '/reports',
    items: [
      { id: 'rep-balance-sheet', to: '/reports/balance-sheet', icon: Scale, iconName: 'Scale', label: 'Balance Sheet', labelKey: 'nav.balanceSheet', permission: 'acc_reports_financial' },
      { id: 'rep-pl', to: '/reports/pl', icon: TrendingUp, iconName: 'TrendingUp', label: 'Profit & Loss', labelKey: 'nav.profitAndLoss', permission: 'acc_reports_financial' },
      { id: 'rep-daybook', to: '/reports/daybook', icon: BookOpen, iconName: 'BookOpen', label: 'Daybook', labelKey: 'nav.daybook', permission: 'acc_reports_view', hidden: true },
      { id: 'rep-trial-balance', to: '/reports/trial-balance', icon: ClipboardList, iconName: 'ClipboardList', label: 'Trial Balance', labelKey: 'nav.trialBalance', permission: 'acc_reports_view', hidden: true },
      { id: 'rep-stock', to: '/reports/stock', icon: Package, iconName: 'Package', label: 'Stock Summary', labelKey: 'nav.stockSummary', feature: 'inv', permission: 'inv_reports_view', hidden: true },
      { id: 'rep-ledger', to: '/reports/ledger', icon: ClipboardList, iconName: 'ClipboardList', label: 'Ledger Statement', labelKey: 'nav.ledgerStatement', permission: 'acc_reports_view', hidden: true },
      { id: 'rep-ratios', to: '/reports/ratios', icon: Activity, iconName: 'Activity', label: 'Ratio Analysis', labelKey: 'nav.ratioAnalysis', feature: 'adv_reports', permission: 'ana_ratio', hidden: true },
