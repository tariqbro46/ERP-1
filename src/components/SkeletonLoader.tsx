...
export const SkeletonLoader: React.FC<SkeletonLoaderProps> = ({
  ...
  if (activeTheme === 'glass') {
    ...
    shimmerGradient = isDarkTheme
      ? `linear-gradient(90deg, rgba(255,255,255,0.03) 0%, ${tintColor} 50%, rgba(255,255,255,0.03) 100%)`
      : `linear-gradient(90deg, rgba(0,0,0,0.02) 0%, ${tintColor} 50%, rgba(0,0,0,0.02) 100%)`;
    ...
    shimmerGradient = `linear-gradient(90deg, rgba(6,182,212,0.01) 0%, ${currentTint.dark} 50%, rgba(244,63,94,0.05) 100%)`;
    ...
    shimmerGradient = isDarkTheme
      ? `linear-gradient(90deg, rgba(39,39,42,0.5) 0%, ${tintColor} 50%, rgba(39,39,42,0.5) 100%)`
      : `linear-gradient(90deg, rgba(241,245,249,0.9) 0%, ${tintColor} 50%, rgba(241,245,249,0.9) 100%)`;
  }
