...
export function ItemMaster() {
  ...
  return (
    <div className="flex flex-col h-full bg-background font-mono transition-colors overflow-hidden">
      ...
      <div className="flex-none bg-background border-b border-border shadow-sm px-4 lg:px-6 py-3.5 z-30">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          {/* Left part: Search and Dropdown in 1 line, search being larger, dropdown being smaller */}
          <div className="flex-1 flex items-center gap-3 max-w-2xl">
            ...
            <div className="relative w-48 flex-shrink-0">
              ...
              <select 
                ...
                className="w-full bg-gray-50 border border-border text-foreground pl-10 pr-8 py-2 text-[10px] outline-none focus:border-foreground transition-all uppercase tracking-widest appearance-none rounded-lg cursor-pointer"
              >
                {categories.map(cat => (
          ...
          <div className="flex flex-wrap items-center gap-4 flex-shrink-0">
            ...
            <button 
              ...
              className="px-3 py-1.5 border border-border text-[10px] font-bold uppercase tracking-widest hover:bg-foreground/5 transition-all flex items-center gap-2 disabled:opacity-50"
            >
            ...
            <button 
              ...
              className="px-3 py-1.5 bg-foreground text-background text-[10px] font-bold uppercase tracking-widest hover:opacity-90 transition-all flex items-center gap-2"
            >
              <Plus className="w-3 h-3" />
              {t('item.createNewItem')}
            </button>
            <div className="text-[10px] text-gray-500 font-bold uppercase tracking-widest pl-1">
