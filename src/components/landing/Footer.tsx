...
export const Footer = () => {
  ...
  return (
    <footer className="border-t border-border py-12" style={{ backgroundColor: globalSettings.footerBgColor }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-[10px] uppercase tracking-widest" style={{ color: globalSettings.footerTextColor }}>
            {globalSettings.footerText}
          </p>
          <div className="flex gap-6">
            <a href="#" className="transition-colors hover:text-foreground" style={{ color: globalSettings.footerTextColor }}>
